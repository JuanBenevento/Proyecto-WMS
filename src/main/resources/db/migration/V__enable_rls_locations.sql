-- =============================================================================
-- Flyway Migration: V__enable_rls_locations.sql
-- =============================================================================
-- Purpose: Enable Row-Level Security (RLS) on the locations table as
...
-- Create tenant isolation policy for locations table
...
GRANT ALL ON locations TO CURRENT_USER;

-- Comment for documentation
COMMENT ON POLICY tenant_isolation_locations ON locations IS
