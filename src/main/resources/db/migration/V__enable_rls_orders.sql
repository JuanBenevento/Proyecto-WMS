-- =============================================================================
-- Flyway Migration: V__enable_rls_orders.sql
-- =============================================================================
-- Purpose: Enable Row-Level Security (RLS) on the orders table as defense-in-depth
...
-- Create tenant isolation policy for orders table
...
GRANT ALL ON orders TO CURRENT_USER;
